...
public class PortalAshParticle extends PortalParticle {
    protected PortalAshParticle(ClientLevel clientLevel, double d, double e, double f, double g, double h, double i, int age, float gravity, float speed, float size, SpriteSet spriteSet) {

...
public class TestConfig extends MidnightConfig {
    ...
    @Comment(category = TEXT) public static Comment teuxt1;                       // Comments are rendered like an option without a button and are excluded from the config file
    ...
    @Entry(category = TEXT, width = 7, min = 7, max = 14, isColor = true, name = "I am a color!") public static String titleColor = "#ffffff"; // The isColor property adds a color chooser for a hexadecimal color

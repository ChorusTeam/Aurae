...
public class SoulSandBlockMixin extends Block {
    ...
    public void animateTick(BlockState blockState, Level level, BlockPos blockPos, RandomSource randomSource) {
        ...
        if(blockState.getBlock() instanceof SoulSandBlock && randomSource.nextInt(1000) == 1 && AmbianceConfig.enableSoulSand && level.getBiome(blockPos).is(BiomeTags.IS_NETHER)) {
